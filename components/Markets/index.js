...
export default connect((state) => state)(function Home({ metamask, library, eventTimestamp }) {
  ...
  const loadData = () => {
    ...
    Promise.all([
      name(),
      token0Symbol(),
      balanceOf(library.addresses.Market1),
      contributeToken(),
      token1Balance(metamask.address),
      allowance(metamask.address, library.addresses.Market1),
      totalCap(),
      totaltoken1Paid(),
      token1PerToken0(),
      totalBuyers(),
  ...
  const handleUnlock = () => {
    ...
    approve(library.addresses.Market1, library.web3.utils.toWei(MIN_ALLOWANCE.toString()), {
  ...
  const handlePurchase = (token1Amount) => {
    const { contributeWei } = library.methods.Market1
    ...
    <HomeWrapper>
          ...
          <div className="body-left">
            ...
            <div className="misc">
              ...
              <div className="external-links">
                ...
                <div>
                  <a href={addressLink(library.addresses.Market1, metamask.network)} target="_blank">
      ...
      {showContributors && (
        <ContributionsModal
          ...
          onPage={(page) => {
            const { contributors } = library.methods.Market1
